...
const ProjectItem = ({ onDelete, index }) => {
          ...
          >
            <div>
              <h2 className="font-poppins text-[14px] font-semibold text-[#1E2532] hover:text-[#1A91F0] transition-colors duration-200">
                {project[index]["project-title"] || "(Not Specified)"}
              </h2>
            </div>
                ...
                <div className="w-[100%]">
                  ...
                  <div className="relative w-full">
                    <input
                      ...
                      id="employer"
                      name="project-title"
                      value={project[index]["project-title"]}
                      onChange={(e) =>
                        handleChange("project-title", e.target.value)
                      }
                ...
                <div className="w-[100%] flex flex-col items-start">
                  ...
                  <div className="w-full h-full pb-2">
                    <div className="relative">
                      <textarea
                        name="description"
                        value={project[index]["description"]}
                        onChange={(e) =>
